...
4. Commit fixes: `git commit -m "fix(<pkg>): address architect review feedback"`
5. Push update: `git push origin <branch-name>`
6. Post resolution note: `gh pr comment <PR_NUMBER> --body "Addressed architect audit findings in commit <sha>."`
